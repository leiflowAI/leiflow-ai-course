...
最近AI还总批评我，让我放下手里的各种活，赶紧去做保险，去见人。折腾AI时间长了，AI都知道我的毛病在哪儿。
...
所以，在 AI 时代，概念不再仅仅是定义，而是进入陌生领域的入口。
-->
...
所以，一定要时不常的 grill 一下，想想哪些地方可能错了？哪些数字需要核实？重要依据在哪里？AI 审一遍，人做最后质检。
-->
...
所以，重要内容，一定要多问一遍，关键数字，必须要点开看一眼，大家先记一个最简单的三步法：
...
#### 国内工具
国内可以选择的 AI 很多，例如豆包、智谱 GLM、Kimi K3、千问、DeepSeek、WorkBuddy 等。我个人比较常用 WorkBuddy，因为它更强调 Agent 式工作，获得授权后可以读写项目文件，也比较适合公众号、小程序等场景。
...
AI也是。在岸上研究一百小时也学不会游泳，先下水，再调整姿势。

好了，今天的分享只是开始。希望以后我们多交流，也多展示自己的 AI 作品。更希望大家在 AI 的帮助下，不断扩展能力边界，把保险展业里的具体问题一个个解决掉。
